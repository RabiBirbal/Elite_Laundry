...
<section class="content">
    <div class="container-fluid">
      ...
      <div class="col-md-12 text-right">
        <p><a href="{{ route('home') }}">Home</a> / <a href="{{ route('slider.show') }}">Slider</a> / Add</p>
    </div>
      ...
      @else
      <div class="col-md-12 text-right">
        <p><a href="{{ route('home') }}">Home</a> / <a href="{{ route('slider.show') }}">Slider</a> / Edit</p>
    </div>
      <div class="card card-primary">
        <div class="card-header">
              ...
              <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <img src="{{ asset('upload/images/slider/'.$slider['image']) }}" alt="" width="200px"><br>
